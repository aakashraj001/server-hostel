...
/**
 * REST controller for managing {@link com.hostl.mgmt.domain.Document}.
 */
@RestController
...
public class DocumentResource {
    ...
    private static final String ENTITY_NAME = "hostelMgmtDocument";
    ...
    public ResponseEntity<Document> partialUpdateDocument(
        ...
        Optional<Document> result = documentRepository
            ...
            .map(existingDocument -> {
                ...
                if (document.getContentContentType() != null) {
                    existingDocument.setContentContentType(document.getContentContentType());
                }
