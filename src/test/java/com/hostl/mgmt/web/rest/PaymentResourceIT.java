...
import static com.hostl.mgmt.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    private static final PaymentMode DEFAULT_MODE = PaymentMode.UPI;
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.uuid(UPDATED_UUID).mode(UPDATED_MODE).date(UPDATED_DATE).value(UPDATED_VALUE).status(UPDATED_STATUS);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.value(UPDATED_VALUE).status(UPDATED_STATUS);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.uuid(UPDATED_UUID).mode(UPDATED_MODE).date(UPDATED_DATE).value(UPDATED_VALUE).status(UPDATED_STATUS);
