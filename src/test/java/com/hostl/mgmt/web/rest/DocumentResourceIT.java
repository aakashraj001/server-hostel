...
import static com.hostl.mgmt.domain.DocumentAsserts.*;
...
import com.hostl.mgmt.domain.Document;
import com.hostl.mgmt.repository.DocumentRepository;
...
class DocumentResourceIT {
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().type(DEFAULT_TYPE).content(DEFAULT_CONTENT).contentContentType(DEFAULT_CONTENT_CONTENT_TYPE);
        return document;
    }
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().type(UPDATED_TYPE).content(UPDATED_CONTENT).contentContentType(UPDATED_CONTENT_CONTENT_TYPE);
        return document;
    }
    ...
    void putExistingDocument() throws Exception {
        ...
        updatedDocument.type(UPDATED_TYPE).content(UPDATED_CONTENT).contentContentType(UPDATED_CONTENT_CONTENT_TYPE);
    ...
    void fullUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.type(UPDATED_TYPE).content(UPDATED_CONTENT).contentContentType(UPDATED_CONTENT_CONTENT_TYPE);
